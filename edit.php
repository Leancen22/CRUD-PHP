<?php 
    ...
    if (isset($_POST['update'])) {
        ...
        $_SESSION['message'] = 'Task Updated Succesfuly';
        ...
        <div class="col-m-4 mx-auto">
            <div class="card card-body">
                <form action="edit.php?id=<?php echo $_GET['id']; ?>" method="POST">
                    ...
                    <div class="form-group">
                        <textarea name="description" rows="3" class="form-control" placeholder="Update Description"><?php echo $description ?></textarea>
                    </div>
